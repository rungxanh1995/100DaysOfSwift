...
class DetailViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    // Add a sharing button to the right of UINavigationBar
    // .action displays the "Sharing" icon
    // target param tells the button that shareTapped method belong to current view controller "self"
  ...
  @objc func shareTapped() {
    ...
    // This code tells iOS to anchor the activity view controller to right bar button item aka Share button
    // On iPhone activity view controller automatically takes up full screen
    // On iPad it appears as a popover & anchored to the Share button
